...
java -jar packr.jar \
  ...
  --output native-linux-x86_64/OpenRSCPlus.AppDir/ \
  --resources binaries/linux/appimage/openrscplus.desktop binaries/linux/appimage/openrscplus.png

pushd native-linux-x86_64/OpenRSCPlus.AppDir

# Symlink AppRun -> OpenRSCPlus
ln -s OpenRSCPlus AppRun

# Ensure OpenRSCPlus is executable for all users
chmod 755 OpenRSCPlus
...
./appimagetool-x86_64.AppImage \
	native-linux-x86_64/OpenRSCPlus.AppDir/ \
