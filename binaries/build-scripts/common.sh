...
# Packr Variables
export PACKR_EXE="OpenRSCPlus"
export PACKR_CLASSPATH="rscplus.jar"
export PACKR_MAIN_CLASS="Client.Launcher"
export PACKR_VM_ARGS="Xmx1500m DusingBinary=openrsc_official DbinaryVersion=$BINARY_VERSION DdownloadWorlds=openrsc_official"
