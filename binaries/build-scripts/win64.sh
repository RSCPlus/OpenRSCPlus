...
java -jar packr.jar \
  ...
  --output native-win64 \
  --resources binaries/win/openrscplus_console.ico binaries/win/openrscplus.ico

# Update the exe
binaries/win/tools/rcedit-x64 native-win64/OpenRSCPlus.exe \
  --application-manifest binaries/win/openrscplus.manifest \
  --set-icon binaries/win/openrscplus.ico

# Run innosetup
iscc binaries/win/innosetup/openrscplus.iss